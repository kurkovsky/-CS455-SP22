...
// Objects of this type (or class) will be used to populate a container (a vector, in this example)
typedef int Foo;
...
int main() {
    // create a vector to store some integers (aka objects of type Foo, in this case)
    vector<Foo> vec;
    const int maxFoo=5;
    ...
    // display the current/extended size of vec
